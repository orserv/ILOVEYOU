                ...
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="text-center w-75 m-auto" style="margin-bottom: 40px!important;">
                            <?php if ($text){?> <img src="https://wcqh.cn/img/hh.svg" style="width: 100%;border-radius: 20px;" alt=""> <?php } ?>
...
<footer class="footer footer-alt">
    Copyright © 2022 Ki. && <a href="https://wcqh.cn/index.php/archives/24/" target="_blank">Like_Girl</a> All
    Rights Reserved.
</footer>
